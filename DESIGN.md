...
AlphaDesk's interface is a literary salon reimagined as a product page — warm, unhurried, and quietly intellectual. The entire experience is built on a parchment-toned canvas (`#f5f4ed`) that deliberately evokes the feeling of high-quality paper rather than a digital surface. Where most AI product pages lean into cold, futuristic aesthetics, AlphaDesk's design radiates human warmth, as if the AI itself has good taste in interior design.

The signature move is the custom AlphaDesk Serif typeface — a medium-weight serif with generous proportions that gives every headline the gravitas of a book title. Combined with organic, hand-drawn-feeling illustrations in terracotta (`#c96442`), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." The serif headlines breathe at tight-but-comfortable line-heights (1.10–1.30), creating a cadence that feels more like reading an essay than scanning a product page.

What makes AlphaDesk's design truly distinctive is its warm neutral palette. Every gray has a yellow-brown undertone (`#5e5d59`, `#87867f`, `#4d4c48`) — there are no cool blue-grays anywhere. Borders are cream-tinted (`#f0eee6`, `#e8e6dc`), shadows use warm transparent blacks, and even the darkest surfaces (`#141413`, `#30302e`) carry a barely perceptible olive warmth. This chromatic consistency creates a space that feels lived-in and trustworthy.

**Key Characteristics:**
- Warm parchment canvas (`#f5f4ed`) evoking premium paper, not screens
- Custom AlphaDesk type family: Serif for headlines, Sans for UI, Mono for code
...
### Primary
- **AlphaDesk Ink** (`#141413`): The primary text color and dark-theme surface — not pure black but a warm, almost olive-tinted dark that's gentler on the eyes. The warmest "black" in any major tech brand.
- **AlphaDesk Terracotta** (`#c96442`): The core brand color — a burnt orange-brown used for primary CTA buttons, brand moments, and the signature accent. Deliberately earthy and un-tech.
...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | AlphaDesk Serif | 64px (4rem) | 500 | 1.10 (tight) | normal | Maximum impact, book-title presence |
| Section Heading | AlphaDesk Serif | 52px (3.25rem) | 500 | 1.20 (tight) | normal | Feature section anchors |
| Sub-heading Large | AlphaDesk Serif | 36–36.8px (~2.3rem) | 500 | 1.30 | normal | Secondary section markers |
| Sub-heading | AlphaDesk Serif | 32px (2rem) | 500 | 1.10 (tight) | normal | Card titles, feature names |
| Sub-heading Small | AlphaDesk Serif | 25–25.6px (~1.6rem) | 500 | 1.20 | normal | Smaller section titles |
| Feature Title | AlphaDesk Serif | 20.8px (1.3rem) | 500 | 1.20 | normal | Small feature headings |
| Body Serif | AlphaDesk Serif | 17px (1.06rem) | 400 | 1.60 (relaxed) | normal | Serif body text (editorial passages) |
| Body Large | AlphaDesk Sans | 20px (1.25rem) | 400 | 1.60 (relaxed) | normal | Intro paragraphs |
| Body / Nav | AlphaDesk Sans | 17px (1.06rem) | 400–500 | 1.00–1.60 | normal | Navigation links, UI text |
| Body Standard | AlphaDesk Sans | 16px (1rem) | 400–500 | 1.25–1.60 | normal | Standard body, button text |
| Body Small | AlphaDesk Sans | 15px (0.94rem) | 400–500 | 1.00–1.60 | normal | Compact body text |
| Caption | AlphaDesk Sans | 14px (0.88rem) | 400 | 1.43 | normal | Metadata, descriptions |
| Label | AlphaDesk Sans | 12px (0.75rem) | 400–500 | 1.25–1.60 | 0.12px | Badges, small labels |
| Overline | AlphaDesk Sans | 10px (0.63rem) | 400 | 1.60 | 0.5px | Uppercase overline labels |
| Micro | AlphaDesk Sans | 9.6px (0.6rem) | 400 | 1.60 | 0.096px | Smallest text |
| Code | AlphaDesk Mono | 15px (0.94rem) | 400 | 1.60 | -0.32px | Inline code, terminal |

### Principles
- **Serif for authority, sans for utility**: AlphaDesk Serif carries all headline content with medium weight (500), giving every heading the gravitas of a published title. AlphaDesk Sans handles all functional UI text — buttons, labels, navigation — with quiet efficiency.
- **Single weight for serifs**: All AlphaDesk Serif headings use weight 500 — no bold, no light. This creates a consistent "voice" across all headline sizes, as if the same author wrote every heading.
...
**Brand Terracotta**
- Background: AlphaDesk Terracotta (`#c96442`)
- Text: Ivory (`#faf9f5`)
- Radius: 8–12px
...
**Dark Primary**
- Background: AlphaDesk Ink (`#141413`)
...
- Logo: AlphaDesk wordmark in AlphaDesk Ink
...
- CTA: AlphaDesk Terracotta button or White Surface button
- Hover: text shifts to foreground-primary, no decoration

### Image Treatment
- Product screenshots showing the AlphaDesk dashboard and daily recommendation interface
...
- Quant score, catalyst signal, and risk flag presented in a clean card grid
- Each card gets a bordered container with metric name, short interpretation, and confidence badge
...
- The primary visual personality — intentionally distinct from high-contrast trading terminals
...
**Shadow Philosophy**: AlphaDesk communicates depth through **warm-toned ring shadows** rather than traditional drop shadows. The signature `0px 0px 0px 1px` pattern creates a border-like halo that's softer than an actual border — it's a shadow pretending to be a border, or a border that's technically a shadow. When drop shadows do appear, they're extremely soft (0.05 opacity, 24px blur) — barely visible lifts that suggest floating rather than casting.
...
### Do
- Use Parchment (`#f5f4ed`) as the primary light background — the warm cream tone IS the AlphaDesk personality
- Use AlphaDesk Serif at weight 500 for all headlines — the single-weight consistency is intentional
- Use AlphaDesk Terracotta (`#c96442`) only for primary CTAs and the highest-signal brand moments
...
- Don't use bold (700+) weight on AlphaDesk Serif — weight 500 is the ceiling for serifs
...
- Don't use geometric/tech-style illustrations — AlphaDesk's illustrations are organic and hand-drawn-feeling
- Don't reduce body line-height below 1.40 — the generous spacing supports the editorial personality
- Don't use monospace fonts for non-code content — AlphaDesk Mono is strictly for code
...
- **Evidence cards**: 3-column → stacked vertical
...
- Brand CTA: "AlphaDesk Terracotta (#c96442)"
- Page Background: "Parchment (#f5f4ed)"
- Card Surface: "Ivory (#faf9f5)"
- Primary Text: "AlphaDesk Ink (#141413)"
...
- "Create a hero section on Parchment (#f5f4ed) with a headline at 64px AlphaDesk Serif weight 500, line-height 1.10. Use AlphaDesk Ink (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 20px AlphaDesk Sans with 1.60 line-height. Place an AlphaDesk Terracotta (#c96442) CTA button with Ivory text, 12px radius."
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in AlphaDesk Serif at 25px weight 500, description in Olive Gray (#5e5d59) at 16px AlphaDesk Sans. Add a whisper shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
- "Build a dark section on AlphaDesk Ink (#141413) with Ivory (#faf9f5) headline text in AlphaDesk Serif at 52px weight 500. Use Warm Silver (#b0aea5) for body text. Borders in Dark Surface (#30302e)."
...
- "Design a recommendation evidence grid with three cards on Ivory surfaces. Each card gets a Border Warm (#e8e6dc) top border, metric title in AlphaDesk Serif at 25px, and interpretation text in Olive Gray at 15px AlphaDesk Sans."
...
4. Describe serif vs sans usage explicitly — "AlphaDesk Serif for the heading, AlphaDesk Sans for the label"
